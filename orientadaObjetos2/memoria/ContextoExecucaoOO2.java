...
public class ContextoExecucaoOO2 extends ContextoExecucaoOO1 implements AmbienteExecucaoOO2 {
	...
	private HashMap<Integer, Integer> blockchain;
	...
	//HFA adicionar aqui a abstração para a blockchain (ver como é feito com os parâmetros fornecedos para execução)
	public ContextoExecucaoOO2(ListaValor entrada, HashMap<Integer, Integer> blockchain) throws VariavelJaDeclaradaException {
		super(entrada);
		arraySuperClasse = new ArrayList <SuperClasseMap> ();
		HashMap<Id, Valor> aux = new HashMap<Id, Valor>();
		aux.put(new Id("super"), new ValorNull());
