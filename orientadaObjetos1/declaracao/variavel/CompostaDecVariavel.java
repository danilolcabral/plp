...
public class CompostaDecVariavel implements DecVariavel {
	...
	/** HFA
	 * Adicionando os getters e setters para viabilizar a inclusão de atributos implícitos.
	 */
	
	public DecVariavel getDeclaracao1() {
		return declaracao1;
	}

	public void setDeclaracao1(DecVariavel declaracao1) {
		this.declaracao1 = declaracao1;
	}

	public DecVariavel getDeclaracao2() {
		return declaracao2;
	}

	public void setDeclaracao2(DecVariavel declaracao2) {
		this.declaracao2 = declaracao2;
	}
