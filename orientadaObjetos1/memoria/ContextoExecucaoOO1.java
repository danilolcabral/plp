...
public class ContextoExecucaoOO1 implements AmbienteExecucaoOO1 {
    ...
    public ContextoExecucaoOO1(AmbienteExecucaoOO1 ambiente) throws VariavelJaDeclaradaException{
       ...
       this.blockchain = ambiente.getBlockchain();
       pilha = new Stack<HashMap<Id, Valor>>();
	...
	@Override
	public Valor readFromBlockchain(ValorInteiro enderecoNaBlockchain) throws EntradaInvalidaException {
		Valor retorno = new ValorInteiro(enderecoNaBlockchain.valor());
		return retorno;
	}
